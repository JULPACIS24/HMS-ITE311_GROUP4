...
<head>
	...
	<title>Test Results - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/test/results') ?>" class="menu-item active"><span class="menu-icon">📄</span>Test Results</a>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					<h1>Test Results</h1>
					<span class="subtext">View and manage laboratory test results</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show all completed laboratory test results.</p>
					<p><strong>URL:</strong> <code>http://localhost/hms_group4/public/laboratory/test/results</code></p>
