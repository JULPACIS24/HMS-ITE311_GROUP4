	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('receptionist/reports') ?>" class="menu-item active"><span class="menu-icon">📈</span>Reports</a>
		...
		<main class="main-content">
			...
			<div class="dashboard-content">
				...
				<div class="card">
					<div class="card-header">Reports Module</div>
					<div class="card-content">
						<p style="color:#7f8c8d">Receptionist reports overview will be built here.</p>
					</div>
				</div>
			</div>
		</main>
