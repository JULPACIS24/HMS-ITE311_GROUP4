	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('receptionist/appointments') ?>" class="menu-item active"><span class="menu-icon">📅</span>Appointments</a>
		...
		<main class="main-content">
			...
			<div class="dashboard-content">
				...
				<div class="card">
					<div class="card-header">Appointments Module</div>
					<div class="card-content">
						<p style="color:#7f8c8d">Receptionist-specific appointment views go here.</p>
					</div>
				</div>
			</div>
		</main>
