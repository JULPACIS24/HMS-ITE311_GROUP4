	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('receptionist/settings') ?>" class="menu-item active"><span class="menu-icon">⚙️</span>Settings</a>
			...
			<div class="dashboard-content">
				...
				<div class="card">
					...
					<div class="card-content">
						<p style="color:#7f8c8d">Receptionist settings and preferences UI goes here.</p>
					</div>
				</div>
			</div>
		</main>
