...
<head>
	...
	<title>Sample Tracking - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/tracking') ?>" class="menu-item active"><span class="menu-icon">📈</span>Sample Tracking</a>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					...
					<span class="subtext">Track laboratory samples and their processing status</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show the tracking information for laboratory samples.</p>
