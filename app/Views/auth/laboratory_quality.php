...
<head>
	...
	<title>Quality Control - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/quality') ?>" class="menu-item active"><span class="menu-icon">🛡️</span>Quality Control</a>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					...
					<span class="subtext">Monitor and maintain laboratory quality standards</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show quality control metrics and procedures.</p>
