...
<head>
	...
	<title>Settings - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/settings') ?>" class="menu-item active"><span class="menu-icon">⚙️</span>Settings</a>
			</div>
		</nav>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					<h1>Settings</h1>
					<span class="subtext">Configure laboratory system settings</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show laboratory configuration settings.</p>
