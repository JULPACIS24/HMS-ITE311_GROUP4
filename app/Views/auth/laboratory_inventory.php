...
<head>
	...
	<title>Lab Inventory - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/inventory') ?>" class="menu-item active"><span class="menu-icon">📦</span>Lab Inventory</a>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					<h1>Lab Inventory</h1>
					<span class="subtext">Manage laboratory supplies and equipment inventory</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show laboratory inventory and supplies.</p>
