...
<head>
	...
	<title>Equipment Status - Laboratory</title>
	...
	<div class="container">
		<nav class="sidebar">
			...
			<div class="sidebar-menu">
				...
				<a href="<?= site_url('laboratory/equipment/status') ?>" class="menu-item active"><span class="menu-icon">⚙️</span>Equipment Status</a>
		...
		<main class="main-content">
			<header class="header">
				<div class="header-left">
					...
					<span class="subtext">Monitor and manage laboratory equipment status</span>
				</div>
			</header>
			...
			<div class="content">
				<div class="card">
					...
					<p>This page will show the current status of all laboratory equipment.</p>
					<p><strong>URL:</strong> <code>http://localhost/hms_group4/public/laboratory/equipment/status</code></p>
